...
<template>
  <div class="admin-content fade-in">
    ...
    <div class="admin-content-header">
      ...
      <div
        class="segmented"
        :style="{ display: 'flex', gap: '2px', background: 'var(--surface)', borderRadius: '8px', padding: '2px' }"
      >
        <button
          class="btn btn-sm"
    ...
    <template v-else>
      ...
      >
        <div class="card" :style="{ padding: 'calc(var(--unit) * 3)' }">
          ...
          <p class="h4">{{ stats.total_eventos_hoy.toLocaleString() }}</p>
        </div>
        <div class="card" :style="{ padding: 'calc(var(--unit) * 3)' }">
          <p class="caption" :style="{ color: 'var(--text-secondary)', marginBottom: 'calc(var(--unit) * 1)' }">
            Vistas únicas
          </p>
          <p class="h4">{{ stats.vistas_unicas.toLocaleString() }}</p>
        </div>
        <div class="card" :style="{ padding: 'calc(var(--unit) * 3)' }">
          <p class="caption" :style="{ color: 'var(--text-secondary)', marginBottom: 'calc(var(--unit) * 1)' }">
        ...
        <div class="card" :style="{ padding: 'calc(var(--unit) * 3)' }">
          ...
          <p class="h4">{{ stats.videos_activos }}</p>
        </div>
      </div>
