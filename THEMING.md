...
| Lienzo              | `--lienzo`                                                                 | El suelo de la página; `--paper` es la superficie que se apoya en él. Antes eran lo mismo y nada podía flotar                                                                                                   |
| Elevación           | `--elev-0` … `--elev-3`                                                    | Dos sombras por nivel (pegada + difusa), tintadas con la tinta y no con negro; en oscuro suben de opacidad                                                                                                      |
| Contorno            | `--borde-ancho`, `--borde-tinta`                                           | El trazo de 2 px de tinta que separa lo TOCABLE de lo informativo sin recurrir al color. La tinta sigue al tema                                                                                                 |
| Elevación dura      | `--elev-dura-1`, `--elev-dura-2`                                           | Sombra de tinta desplazada, sin difuminar: la superficie se «apoya», no flota. Solo donde se espera un toque. En oscuro es `none` y el contorno queda como única señal                                          |
| Pastel de categoría | `--cat-red/datos/seguridad/personas` + `--sobre-cat-*`                     | El color por el que se reconoce un curso antes que por su texto. Fondo fijo + tinta fija (no siguen al modo, como los `--sobre-*`): cada pastel declara su tinta para cumplir la regla del par por construcción |
